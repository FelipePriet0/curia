...
export default function CookiePolicyPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      <h1 className="font-curia-rounded text-2xl text-[#2B1A07]">Política de Cookies</h1>
      ...
      <section className="mt-6 space-y-4 font-curia-serif text-sm text-[#2B1A07]/80 leading-relaxed">
        <div>
          <h2 className="font-semibold text-[#2B1A07]">1. O que são cookies</h2>
          <p>Pequenos arquivos armazenados no seu dispositivo para lembrar preferências e melhorar a experiência.</p>
        </div>
        <div>
          <h2 className="font-semibold text-[#2B1A07]">2. Tipos que utilizamos</h2>
        ...
        <div>
          <h2 className="font-semibold text-[#2B1A07]">3. Gerenciamento</h2>
        ...
        <div>
          <h2 className="font-semibold text-[#2B1A07]">4. Alterações</h2>
