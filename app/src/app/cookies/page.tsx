  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      <div className="mt-6 space-y-4">
        <div className="rounded-xl border border-[hsl(var(--border))] bg-white p-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-medium text-[#0B0B0F]">Essenciais</p>
        ...
        <div className="rounded-xl border border-[hsl(var(--border))] bg-white p-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-medium text-[#0B0B0F]">Funcionais</p>
        ...
        <div className="rounded-xl border border-[hsl(var(--border))] bg-white p-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-medium text-[#0B0B0F]">Analytics</p>
        ...
        <div className="rounded-xl border border-[hsl(var(--border))] bg-white p-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-medium text-[#0B0B0F]">Marketing</p>
      ...
      <div className="mt-6 flex flex-wrap gap-2">
        <button onClick={savePreferences} className="rounded-xl bg-[#0B0B0F] px-4 py-2 text-sm font-semibold text-white hover:opacity-90">Salvar preferências</button>
        <button onClick={acceptAll} className="rounded-xl border border-[hsl(var(--border))] px-4 py-2 text-sm font-medium text-[#0B0B0F]/80 hover:bg-[#0B0B0F]/[0.05]">Aceitar todos</button>
        <button onClick={rejectAll} className="rounded-xl border border-[hsl(var(--border))] px-4 py-2 text-sm font-medium text-[#0B0B0F]/80 hover:bg-[#0B0B0F]/[0.05]">Rejeitar não essenciais</button>
      </div>

      {saved && (
        <p className="mt-3 text-xs text-green-700">Preferências atualizadas.</p>
      )}

      <p className="mt-8 text-xs text-[#0B0B0F]/50">
